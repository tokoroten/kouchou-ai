...
sys.modules["services.parse_json_list"] = type(
    "MockParseJsonList", (), {"parse_response": lambda *args, **kwargs: None}
)
...
def test_extract_arguments_batch_success(mock_request_to_chat_openai):
    ...
    mock_response = {"1": ["argument1", "argument2"], "2": ["argument3"]}
...
def test_extract_batch_success(mock_extract_arguments_batch):
    ...
    mock_extract_arguments_batch.return_value = {"1": ["argument1", "argument2"], "2": ["argument3"]}
...
def test_extract_batch_with_fallback(mock_extract_arguments_batch, mock_extract_arguments):
    ...
    mock_extract_arguments.side_effect = [["argument1"], ["argument2"], ["argument3"]]
...
def test_extract_batch_with_partial_results(mock_extract_arguments_batch):
    ...
    mock_extract_arguments_batch.return_value = {"1": ["argument1"], "3": ["argument3"]}
